...
Routes:
- ``GET  /health``   â€” service health (FR-010, AC-010); no auth.
- ``POST /feedback``  â€” submit feedback (FR-002..FR-006); no auth; server-side
  validation; persists then returns 201.
- ``GET  /feedback``  â€” list feedback (FR-007..FR-009); gated by the
